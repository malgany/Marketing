...
export default function App() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 z-[1] bg-[radial-gradient(circle_at_center,rgba(255,255,255,0)_8%,rgba(245,243,238,0.05)_48%,rgba(245,243,238,0.22)_100%)]" />
